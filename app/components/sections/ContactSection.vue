...
const { email, github, nameFirst, nameLast } = profile
const { message, note, emailLabel, githubLabel } = profile.contact
</script>
...
<template>
  <section id="contact" class="page-section contact">
    ...
    >
      ...
      <div class="section-divider" style="margin:0 auto 1.75rem" />

      <div class="card contact-card">
        <p class="contact-msg">{{ message }}</p>

        <div class="contact-btns">
          <a :href="`mailto:${email}`" class="btn btn-filled">
    ...
    <p class="footer-txt">© {{ new Date().getFullYear() }} {{ nameFirst }} {{ nameLast }}</p>
  </section>
</template>
